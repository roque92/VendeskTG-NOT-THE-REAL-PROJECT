...
import com.vendeskgt.vendeskgt.service.TenantCreateService;
...
@Configuration
public class TenantCreateFunction {


    private final TenantCreateService tenantCreateService;

    @Autowired
    public TenantCreateFunction(TenantCreateService tenantCreateService) {
        this.tenantCreateService = tenantCreateService;
    }
    ...
    public Function<TenantWithSubscriptionRegistrationRequest, Map<String, Object>> registerCustomer() {
        return request -> {
            try {
                ...
                TenantRegistrationResponse resp = tenantCreateService.register(request);
                return Map.of(
                        "success", true,
                        "data", resp
                );
